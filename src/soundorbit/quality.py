...
_PRESETS: dict[str, QualityProfile] = {
    ...
    "low": QualityProfile(
        ...
        fbo_scale=0.40,
        trail_decay=0.78,
        trail_scene_gain=0.30,
        trail_mix=0.38,
        aberration=0.00055,
        # PS1-ish temporal jag: low/medium sit near 12–16 fps（排熱優先）
        target_fps=12,
        particle_emit_scale=0.18,
    ),
    "medium": QualityProfile(
        ...
        fbo_scale=0.48,
        trail_decay=0.82,
        trail_scene_gain=0.34,
        trail_mix=0.44,
        aberration=0.00065,
        target_fps=15,
        particle_emit_scale=0.32,
    ),
    "high": QualityProfile(
        key="high",
        label="高",
        ...
        fbo_scale=0.55,
        trail_decay=0.84,
        trail_scene_gain=0.36,
        trail_mix=0.48,
        aberration=0.00075,
        target_fps=18,
        particle_emit_scale=0.45,
    ),
